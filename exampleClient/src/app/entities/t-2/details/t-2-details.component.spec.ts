...
import { IT2, T2Service, T2DetailsComponent, T2ListComponent } from '../';
...
describe('T2DetailsComponent', () => {
  let component: T2DetailsComponent;
  let fixture: ComponentFixture<T2DetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(T2DetailsComponent);
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 't2', component: T2DetailsComponent },
            { path: 't2/:id', component: T2ListComponent }
          ])
        ],
        providers: [
          T2Service
